...
exports.default = (app) => {
    try {
        // Private Key
        const privateKey = fs_1.default.readFileSync(path_1.default.resolve('./certificates/key.pem'), 'utf8');
        const pubCertificate = fs_1.default.readFileSync(path_1.default.resolve('./certificates/cert.pem'), 'utf8');
